...
router.get("/settings", authMiddleware.isAuthenticated, userController.settings);
...
router.post("/new-post", authMiddleware.isAuthenticated, upload.single('image'), postController.doNewPost);
